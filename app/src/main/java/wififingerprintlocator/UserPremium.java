...
public class UserPremium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        get.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(UserPremium.this, MainActivity.class);
                startActivity(intent);
                UserPremium.this.finish();
            }
        });
    }
    ...
    private void startScanning() {
        ...
        UserPremium.WifiReceiver receiverWifi = new UserPremium.WifiReceiver(wifi);
            ...
            photoView.setOnPhotoTapListener(new OnPhotoTapListener() {
                ...
                public void onPhotoTap(ImageView view, float x, float y) {
                    ...
                    new CountDownTimer(5000,1000)
                    {
                        ...
                        public void onFinish() {
                            getAverageRSSI2(rssMap, posX, posY);
                        }
                    }.start();
                }
            });
    ...
    class DrawLineTransformation implements Transformation {
        ...
        public Bitmap transform(Bitmap bitmap) {
            // TODO Auto-generated method stub
            synchronized (UserLocation.DrawLineTransformation.class) {
                if(bitmap == null) {
                    return null;
                }
                    ...
                    for(AccessPoint auxiliar : rssisList){
                        ...
                        if(p==(rssisList.size())){
                            ...
                            if(!posicao.matches("0.0"))
                            {
                                if(minD > dist)
                                {
                                    Toast.makeText(UserPremium.this, "Calculating your position! Wait please!!", Toast.LENGTH_SHORT).show();
                                    minD = dist;
    ...
    private void getAverageRSSI2(Map<AccessPointConfirmation,ArrayList<Integer>> rssi, int x, int y)
    {
